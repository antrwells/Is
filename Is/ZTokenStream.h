...
enum TokenType {
	...
	TokenVirtual,TokenVar,TokenBool,TokenTrue,TokenFalse,TokenList,TokenForEach,TokenListAdd,TokenListRemove,TokenEnum,TokenExpr,TokenMem,TokenLeftArray,TokenRightArray
};
